...
def montar_payload_consulta(valor_prestador: str, mes_emissao: int, ano_emissao: int, origem_texto: str) -> dict:
    ...
    return {
        ...
        "parametrosTela.nrMesCompetencia":  str(mes_emissao),
        "parametrosTela.nrAnoCompetencia": str(ano_emissao),
        "parametrosTela.nrMesCompetenciaEmissao": "",
        "parametrosTela.nrAnoCompetenciaEmissao": "",
